...
// src/bases/create-task-bases.ts
async function runCreateTaskBases(app, settings) {
...
async function promptOverwriteConfirm(app, path) {
  return await new Promise((resolve) => {
    class OverwriteConfirmModal extends import_obsidian2.Modal {
      constructor() {
        super(...arguments);
        this.resolved = false;
      }
